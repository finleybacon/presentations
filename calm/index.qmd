...
::: {.fragment .fade-left}
{{< include code-blocks/workflow-i.md >}}
:::
...
{{< include code-blocks/workflow-ii.md >}}
...
3. Apply styles
:::
{{< include code-blocks/workflow-iii.md >}}
...
::: {.fragment .fade-left}
{{< include code-blocks/core-schema.md >}}
:::
...
::: {.fragment .fade-left}
{{< include code-blocks/calm-cli.md >}}
:::
...
::: {.fragment .fade-left}
{{< include code-blocks/consumer-pattern-3.md >}}
:::
...
::: {.fragment .fade-left}
{{< include code-blocks/consumer-pattern-3-control.md >}}
:::

## Requirement

::: {.fragment .fade-left}
{{< include code-blocks/control-requirement.md >}}
:::

## Config

::: {.fragment .fade-left}
{{< include code-blocks/control-config.md >}}
:::
...
::: {.fragment .fade-left}
{{< include code-blocks/validate-no-errors.md >}}
:::

## Now let's change the architecture {data-menu-title="Architecture Change (i)"}

::: {.fragment .fade-left}
{{< include code-blocks/architecture-valid.md >}}
:::

## Now let's change the architecture {data-menu-title="Architecture Change (ii)"}

{{< include code-blocks/architecture-invalid.md >}}
...
::: {.fragment .fade-left}
{{< include code-blocks/validate-errors.md >}}
:::
